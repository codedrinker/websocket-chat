 ...
 */
    !function (a) {
        ...
        a(function () {
            ...
            c.scrollspy({target: ".bs-docs-sidebar"}), b.on("load", function () {
            ...
            }(), a(".tooltip-demo").tooltip({selector: '[data-toggle="tooltip"]', container: "body"}), a(".popover-demo").popover({selector: '[data-toggle="popover"]', container: "body"}), a(".tooltip-test").tooltip(), a(".popover-test").popover(), a(".bs-docs-popover").popover(), a("#loading-example-btn").click(function () {
                var b = a(this);
                ...
                var b = a(this), c = b.prev(), d = '<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div>';
            ...
            d.on("load", function () {
                ...
                e.attr("title", "已复制!").tooltip("fixTitle").tooltip("show").attr("title", "复制到剪贴板").tooltip("fixTitle")
            }), d.on("noflash wrongflash", function () {
                e.attr("title", "你的浏览器需要安装 Flash 插件！").tooltip("fixTitle").tooltip("show")
            })
        })
    }(jQuery);